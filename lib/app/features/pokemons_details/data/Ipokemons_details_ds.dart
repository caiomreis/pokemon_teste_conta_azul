...
class IPokemonDetailsListDataSource {
  ...
  factory IPokemonDetailsListDataSource.fromRawJson(String str) =>
      IPokemonDetailsListDataSource.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory IPokemonDetailsListDataSource.fromJson(Map<String, dynamic> json) =>
      IPokemonDetailsListDataSource(
